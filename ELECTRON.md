...
The stable application id is `com.thalex35.childrenmanagement`. Do not change it between releases. Updates and publishing use `Thalex35/TeacherHub`. GitHub Actions uses its built-in `GITHUB_TOKEN`; no service-role or signing credentials are stored in the repository.
