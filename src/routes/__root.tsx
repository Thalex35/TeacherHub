  ...
  head: () => ({
    meta: [
      ...
      { title: "TeacherHub — Teacher Management Platform" },
      {
        name: "description",
        content:
          "TeacherHub is a private teacher workspace for classes, students, curriculum, grades, attendance and reports.",
      },
      { property: "og:title", content: "TeacherHub — Teacher Management Platform" },
      {
        property: "og:description",
        content: "Manage classes, curriculum, assignments, grades and attendance in one place.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      {
        name: "google-site-verification",
        content: "826hF6uMef0GY5wnSrlv1V9p4eIMHkClQg_pcAGg_58",
      },
    ],
    links: [
      {
